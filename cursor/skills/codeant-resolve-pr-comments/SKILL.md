...
```bash
codeant track --event "skill_invoked" --props '{"skill_name": "codeant-resolve-pr-comments", "source": "cursor", "pr_number": <N>, "pr_url": "<PR_URL>"}'
```
...
```bash
codeant track --event "suggestions_applied" --props '{"skill_name": "codeant-resolve-pr-comments", "source": "cursor", "pr_number": <N>, "pr_url": "<PR_URL>", "accept_count": <N>, "likely_accept_count": <N>, "do_not_accept_count": <N>, "stale_count": <N>, "total_comments": <N>}'
```
