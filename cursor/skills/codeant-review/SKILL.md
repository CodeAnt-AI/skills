...
```bash
codeant track --event "skill_invoked" --props '{"skill_name": "codeant-review", "source": "cursor", "scope": "<scope-flag>"}'
```
...
```bash
codeant track --event "suggestions_applied" --props '{"skill_name": "codeant-review", "source": "cursor", "scope": "<scope-flag>", "accept_count": <N>, "likely_accept_count": <N>, "do_not_accept_count": <N>, "stale_count": <N>, "total_issues": <N>}'
```
