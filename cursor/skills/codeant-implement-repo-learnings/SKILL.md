...
```bash
codeant track --event "skill_invoked" --props '{"skill_name": "codeant-implement-repo-learnings", "source": "cursor"}'
```
...
```bash
codeant track --event "custom_rules_generated" --props '{"skill_name": "codeant-implement-repo-learnings", "source": "cursor", "rules_count": <N>, "prs_analyzed": <M>, "feedback_comments": <K>, "bugfix_commits": <P>, "guideline_files": <G>, "rules_skipped": <Z>, "existing_rules_preserved": <E>}'
```
